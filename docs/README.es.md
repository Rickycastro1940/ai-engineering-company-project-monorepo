...
- **Observabilidad**: [plan de telemetría de Brasaland](telemetry/telemetry-plan.md), [esquemas de eventos](telemetry/event-schemas.json) y [listas blancas de propiedades](telemetry/property-allowlists.md).
