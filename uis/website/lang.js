(function () {
    ...
    const STRINGS = {
        en: {
            ...
            "footer.contact.markets": "Colombia and Florida (US)",
            "footer.contact.note": "Street addresses and phone numbers are not published in the company knowledge base.",
            "footer.contact.suppliers": "Supplier application",
            ...
            "home.value.markets": "One chain in Colombia and Florida — miami-downtown, bogota-norte, and COL-01 through COL-10.",
            "home.value.grill": "Sirloin, ribs, and chicken over the brasa, with house sauce and corn arepas.",
            "home.value.points": "Brasa Points work at every location. Florida stays in USD $; Colombia stays in COP $ — we never convert one into the other.",
            "home.cta.menu": "See the menu",
            "home.cta.loyalty": "Join Brasa Points",
            "home.cta.apply": "Apply as a supplier",
            "home.how.h2": "How a visit works",
            "home.how.lede": "The table is the same in Colombia and Florida: grill, sauce, arepa, and Brasa Points that follow you to every location.",
            "home.how.step1.h3": "Sit down at a Brasaland",
            "home.how.step1.p": "Walk into miami-downtown, bogota-norte, or any COL-01 through COL-10 location. Prices stay in that market’s currency.",
            "home.how.step2.h3": "Eat from the grill",
            "home.how.step2.p": "Order sirloin, ribs, or chicken over the brasa. Add tropical salad, a corn arepa, and house sauce. Tell the server about allergies before the kitchen starts.",
            "home.how.step3.h3": "Earn and redeem Brasa Points",
            "home.how.step3.p": "Earn 1 point for every 10 USD in Florida or every 10,000 COP in Colombia. Redeem from 15 points, in steps of 5. Five points equal 20 USD or 20,000 COP off the bill.",
            "home.benefits.h2": "Brasa Points benefits",
            "home.benefits.lede": "Tiers stack as you earn. Points stay valid while the account is active — at least one purchase every 12 months. Accounts are individual and not shared.",
            "home.benefits.bronze.h3": "Bronze · 0–19 points",
            "home.benefits.bronze.p": "5% off drinks on Tuesdays.",
            "home.benefits.silver.h3": "Silver · 20–49 points",
            "home.benefits.silver.p": "10% off the main dish, once a month.",
            "home.benefits.gold.h3": "Gold · 50+ points",
            "home.benefits.gold.p": "15% permanent discount and early access to the seasonal menu.",
            "home.suppliers.h2": "Supply the grill",
            "home.suppliers.lede": "Locations order proteins weekly, produce twice a week, beverages and packaging biweekly, and imported sauces monthly. Emergency protein orders carry an 8% surcharge. Apply with the same directory fields operations uses.",
            "home.local.h2": "Run locally in Codespaces",
            "home.local.lede": "From the repository root, serve this site with a Codespaces-compatible command. Binding to 0.0.0.0 exposes port 3000 for port forwarding.",
            "home.local.note": "Then open http://127.0.0.1:3000/ for the landing page and http://127.0.0.1:3000/application.html for the supplier form.",
            ...
            "alt.logo": "Brasaland logo: a white flame over a grill on an ember square",
            "alt.sirloin": "Sliced grilled sirloin, Lomo a la Brasa, with grill marks and green onion",
        ...
        es: {
            ...
            "footer.contact.markets": "Colombia y Florida (EE. UU.)",
            "footer.contact.note": "Las direcciones y los teléfonos no están publicados en la base de conocimiento de la compañía.",
            "footer.contact.suppliers": "Solicitud de proveedores",
            ...
            "home.value.markets": "Una cadena en Colombia y Florida — miami-downtown, bogota-norte y COL-01 a COL-10.",
            "home.value.grill": "Lomo, costillas y pollo a la brasa, con salsa de la casa y arepa de maíz.",
            "home.value.points": "Brasa Points funciona en todas las sedes. Florida se queda en USD $; Colombia se queda en COP $ — nunca convertimos una moneda en la otra.",
            "home.cta.menu": "Ver el menú",
            "home.cta.loyalty": "Unirse a Brasa Points",
            "home.cta.apply": "Postularse como proveedor",
            "home.how.h2": "Cómo funciona una visita",
            "home.how.lede": "La mesa es la misma en Colombia y Florida: parrilla, salsa, arepa y Brasa Points que te siguen a todas las sedes.",
            "home.how.step1.h3": "Siéntate en un Brasaland",
            "home.how.step1.p": "Entra a miami-downtown, bogota-norte o cualquier sede COL-01 a COL-10. Los precios se quedan en la moneda de ese mercado.",
            "home.how.step2.h3": "Come de la parrilla",
            "home.how.step2.p": "Pide lomo, costillas o pollo a la brasa. Suma ensalada tropical, arepa de maíz y salsa de la casa. Avisa al mesero de alergias antes de que la cocina empiece.",
            "home.how.step3.h3": "Gana y canjea Brasa Points",
            "home.how.step3.p": "Ganas 1 punto por cada 10 USD en Florida o por cada 10.000 COP en Colombia. Se canjea desde 15 puntos, de 5 en 5. Cinco puntos equivalen a 20 USD o 20.000 COP de descuento en la cuenta.",
            "home.benefits.h2": "Beneficios de Brasa Points",
            "home.benefits.lede": "Los niveles suben a medida que ganas. Los puntos siguen válidos mientras la cuenta esté activa — al menos una compra cada 12 meses. Las cuentas son individuales y no se comparten.",
            "home.benefits.bronze.h3": "Bronce · 0–19 puntos",
            "home.benefits.bronze.p": "5% de descuento en bebidas los martes.",
            "home.benefits.silver.h3": "Plata · 20–49 puntos",
            "home.benefits.silver.p": "10% de descuento en el plato principal, una vez al mes.",
            "home.benefits.gold.h3": "Oro · 50+ puntos",
            "home.benefits.gold.p": "15% de descuento permanente y acceso anticipado al menú de temporada.",
            "home.suppliers.h2": "Abastecer la parrilla",
            "home.suppliers.lede": "Las sedes piden proteínas semanalmente, produce dos veces por semana, bebidas y empaques cada dos semanas, y salsas importadas cada mes. Los pedidos de emergencia de proteína llevan un recargo del 8%. Postúlate con los mismos campos del directorio de operaciones.",
            "home.local.h2": "Ejecutar en local en Codespaces",
            "home.local.lede": "Desde la raíz del repositorio, sirve este sitio con un comando compatible con Codespaces. Enlazar a 0.0.0.0 expone el puerto 3000 para el reenvío de puertos.",
            "home.local.note": "Luego abre http://127.0.0.1:3000/ para la página de inicio y http://127.0.0.1:3000/application.html para el formulario de proveedores.",
            ...
            "alt.logo": "Logo de Brasaland: llama blanca sobre una parrilla en un cuadro ámbar",
            "alt.sirloin": "Lomo a la brasa en rodajas, con marcas de parrilla y cebollín",
